...
final class Journal extends Base
{
     ...
     * @var OdooRelation|null
     */
    private $payment_debit_account_id;
     ...
     * @var OdooRelation|null
     */
    private $payment_credit_account_id;
     ...
     * @var string
     */
    private $invoice_reference_type;
     ...
     * @var string
     */
    private $invoice_reference_model;
     ...
     * @var string|null
     */
    private $sequence_override_regex;
     ...
     * @var OdooRelation[]|null
     */
    private $outbound_payment_method_ids;
     ...
     * @var string|null
     */
    private $bank_statements_source;
     ...
     * @var string|null
     */
    private $kanban_dashboard_graph;
     ...
     * @var bool|null
     */
    private $check_printing_payment_method_selected;
     ...
     * @var OdooRelation|null
     */
    private $account_online_journal_id;
     ...
     * @var string|null
     */
    private $bank_statement_creation;
     ...
     * @var DateTimeInterface|null
     */
    private $next_link_synchronization;
     ...
     * @var OdooRelation|null
     */
    private $account_online_account_id;
     ...
     * @var string|null
     */
    private $account_online_link_state;

    /**
     * Bank Statements Group By
     * ---
     * Defines when a new bank statement will be created when fetching new transactions from your bank account.
     * ---
     * Selection :
     *     -> none (Create one statement per synchronization)
     *     -> day (Create daily statements)
     ...
     * @var string|null
     */
    private $bank_statement_creation_groupby;
     ...
     * @return string|null
     *
     * @SerializedName("account_online_link_state")
     */
    public function getAccountOnlineLinkState(): ?string
    {
        return $this->account_online_link_state;
    }

    /**
     * @param string|null $account_online_link_state
     */
    public function setAccountOnlineLinkState(?string $account_online_link_state): void
    {
        $this->account_online_link_state = $account_online_link_state;
    }

    /**
     * @return string|null
     *
     * @SerializedName("bank_statement_creation_groupby")
     */
    public function getBankStatementCreationGroupby(): ?string
    {
        return $this->bank_statement_creation_groupby;
    }

    /**
     * @param string|null $bank_statement_creation_groupby
     */
    public function setBankStatementCreationGroupby(?string $bank_statement_creation_groupby): void
    {
        $this->bank_statement_creation_groupby = $bank_statement_creation_groupby;
    }
    ...
    /**
     * @param OdooRelation|null $account_online_account_id
     */
    public function setAccountOnlineAccountId(?OdooRelation $account_online_account_id): void
    {
        $this->account_online_account_id = $account_online_account_id;
    }
     ...
     * @return OdooRelation|null
     *
     * @SerializedName("account_online_account_id")
     */
    public function getAccountOnlineAccountId(): ?OdooRelation
    {
        return $this->account_online_account_id;
    }
     ...
     * @return DateTimeInterface|null
     *
     * @SerializedName("next_link_synchronization")
     */
    public function getNextLinkSynchronization(): ?DateTimeInterface
    {
        return $this->next_link_synchronization;
    }

    /**
     * @param DateTimeInterface|null $next_link_synchronization
     */
    public function setNextLinkSynchronization(?DateTimeInterface $next_link_synchronization): void
    {
        $this->next_link_synchronization = $next_link_synchronization;
    }
