...
final class Calendar extends Base
{
     ...
     * @see \Tests\FluxSE\OdooApiClient\TestModel\Object\Resource_\Calendar\Attendance
     * ---
     * Searchable : yes
     * Sortable : no
     *
     ...
     * @see \Tests\FluxSE\OdooApiClient\TestModel\Object\Resource_\Calendar\Leaves
     * ---
     * Searchable : yes
     * Sortable : no
     *
     ...
     * @return float|null
     *
     * @SerializedName("work_time_rate")
     */
    public function getWorkTimeRate(): ?float
    {
        return $this->work_time_rate;
    }
    ...
    /**
     * @param float|null $work_time_rate
     */
    public function setWorkTimeRate(?float $work_time_rate): void
    {
        $this->work_time_rate = $work_time_rate;
    }
