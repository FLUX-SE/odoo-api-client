...
final class Test extends Base
{
     ...
     * Line
     * ---
     * Relation : one2many (base.automation.line.test -> lead_id)
     * @see \Flux\OdooApiClient\Model\Object\Base\Automation\Line\Test
     * ---
     * Searchable : yes
     * Sortable : no
     *
     ...
     * @return bool|null
     *
     * @SerializedName("is_assigned_to_admin")
     */
     ...
     * @return DateTimeInterface|null
     *
     * @SerializedName("date_action_last")
     */
