...
final class Filters extends Base
{
     ...
     *     -> sale.coupon.generate (Generate Sales Coupon)
     ...
     *     -> sale.coupon (Sales Coupon)
     *     -> sale.coupon.apply.code (Sales Coupon Apply Code)
     *     -> sale.coupon.program (Sales Coupon Program)
     *     -> report.sale_coupon.report_coupon (Sales Coupon Report)
     *     -> sale.coupon.reward (Sales Coupon Reward)
     *     -> sale.coupon.rule (Sales Coupon Rule)
