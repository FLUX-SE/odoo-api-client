...
final class Department extends Base
{
     ...
     * Child Departments
     * ---
     * Relation : one2many (hr.department -> parent_id)
     * @see \Flux\OdooApiClient\Model\Object\Hr\Department
     * ---
     * Searchable : yes
     * Sortable : no
     ...
     * Members
     * ---
     * Relation : one2many (hr.employee -> department_id)
     * @see \Flux\OdooApiClient\Model\Object\Hr\Employee
     * ---
     * Searchable : yes
     * Sortable : no
     ...
     * Jobs
     * ---
     * Relation : one2many (hr.job -> department_id)
     ...
     * @var int|null
     */
    private $expense_sheets_to_approve_count;
    ...
    /**
     * @param OdooRelation[]|null $member_ids
     */
    ...
    /**
     * @param OdooRelation|null $manager_id
     */
    public function setManagerId(?OdooRelation $manager_id): void
    {
     ...
     * @param OdooRelation $item
     */
    public function addMemberIds(OdooRelation $item): void
    {
     ...
     * @return bool
     */
    public function hasMemberIds(OdooRelation $item): bool
    {
        if (null === $this->member_ids) {
            return false;
        }

        return in_array($item, $this->member_ids);
    }

    /**
     * @param OdooRelation $item
     */
    public function removeMemberIds(OdooRelation $item): void
    {
        if (null === $this->member_ids) {
            $this->member_ids = [];
        }
    ...
    /**
     * @param int|null $expense_sheets_to_approve_count
     */
    public function setExpenseSheetsToApproveCount(?int $expense_sheets_to_approve_count): void
    {
        $this->expense_sheets_to_approve_count = $expense_sheets_to_approve_count;
    }
    ...
    {
        return $this->jobs_ids;
    }

    /**
     * @return int|null
     *
     * @SerializedName("expense_sheets_to_approve_count")
     */
    public function getExpenseSheetsToApproveCount(): ?int
    {
        return $this->expense_sheets_to_approve_count;
    }
     ...
     * @param OdooRelation $item
     */
    public function removeJobsIds(OdooRelation $item): void
    {
        if (null === $this->jobs_ids) {
            $this->jobs_ids = [];
        }

        if ($this->hasJobsIds($item)) {
            $index = array_search($item, $this->jobs_ids);
            unset($this->jobs_ids[$index]);
        }
    }
     ...
     * @param OdooRelation $item
     */
    public function addJobsIds(OdooRelation $item): void
    {
        if ($this->hasJobsIds($item)) {
            return;
        }
     ...
     * @return bool
     */
    public function hasJobsIds(OdooRelation $item): bool
    {
        if (null === $this->jobs_ids) {
            return false;
        }

        return in_array($item, $this->jobs_ids);
    }

    /**
     * @param OdooRelation[]|null $jobs_ids
     */
    public function setJobsIds(?array $jobs_ids): void
    {
        $this->jobs_ids = $jobs_ids;
    }
