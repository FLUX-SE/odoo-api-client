...
final class Program extends Reward
{
     ...
     * Coupon Rule
     * ---
     * Relation : many2one (coupon.rule)
     * @see \Flux\OdooApiClient\Model\Object\Coupon\Rule
     * ---
     * Searchable : yes
     * Sortable : yes
     *
     ...
     * Reward
     * ---
     * Relation : many2one (coupon.reward)
     * @see \Flux\OdooApiClient\Model\Object\Coupon\Reward
     * ---
     * Searchable : yes
     * Sortable : yes
     *
     ...
     * Generated Coupons
     * ---
     * Relation : one2many (coupon.coupon -> program_id)
