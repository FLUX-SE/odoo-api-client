...
namespace Flux\OdooApiClient\Model\Object\Res\Users;
...
/**
 * Odoo model : res.users.identitycheck
 * ---
 ...
 *         the account.
 */
final class Identitycheck extends Base
{
    /**
     * Password
     * ---
    ...
    {
        return 'res.users.identitycheck';
    }
}
