...
namespace Flux\OdooApiClient\Model\Object\Stock\Production;
...
/**
 * Odoo model : stock.production.lot
 * ---
...
final class Lot extends Base
{
     ...
     * Quants
     * ---
     * Relation : one2many (stock.quant -> lot_id)
     ...
     * Purchase Orders
     * ---
     * Relation : many2many (purchase.order)
    ...
    /**
     * @param string $name Lot/Serial Number
     *        ---
     *        Unique Lot/Serial Number
     *        ---
     *        Searchable : yes
     ...
     *        Sortable : yes
     */
    public function __construct(string $name, OdooRelation $product_id, OdooRelation $company_id)
    {
        $this->name = $name;
     ...
     * @return bool
     */
    public function hasPurchaseOrderIds(OdooRelation $item): bool
    {
        if (null === $this->purchase_order_ids) {
            return false;
        }

        return in_array($item, $this->purchase_order_ids);
    }

    /**
     * @param OdooRelation[]|null $purchase_order_ids
     */
    public function setPurchaseOrderIds(?array $purchase_order_ids): void
    {
     ...
     */
    public function getPurchaseOrderIds(): ?array
    {
        return $this->purchase_order_ids;
    }
    ...
    /**
     * @param bool|null $display_complete
     */
    public function setDisplayComplete(?bool $display_complete): void
    {
        $this->display_complete = $display_complete;
    }

    /**
     * @return bool|null
     *
     * @SerializedName("display_complete")
     */
    public function isDisplayComplete(): ?bool
    {
