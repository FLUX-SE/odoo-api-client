...
final class Inventory extends Base
{
     ...
     * Counted Quantities
     * ---
     * Allows to start with a pre-filled counted quantity for each lines or with all counted quantities set to zero.
     * ---
     * Selection :
     ...
     * ---
     * Include also products with quantity of 0
     * ---
     * Searchable : yes
     * Sortable : yes
     *
