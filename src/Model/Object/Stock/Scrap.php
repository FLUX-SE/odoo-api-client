...
final class Scrap extends Base
{
     ...
     *        Searchable : yes
     *        Sortable : yes
     * @param OdooRelation $scrap_location_id Scrap Location
     *        ---
     *        Relation : many2one (stock.location)
     *        @see \Flux\OdooApiClient\Model\Object\Stock\Location
     *        ---
     *        Searchable : yes
     *        Sortable : yes
     * @param float $scrap_qty Quantity
     *        ---
     *        Searchable : yes
     *        Sortable : yes
     */
    public function __construct(
        ...
        OdooRelation $scrap_location_id,
        float $scrap_qty
    ) {
        $this->name = $name;
    ...
    /**
     * @param float $scrap_qty
     */
    public function setScrapQty(float $scrap_qty): void
    {
        $this->scrap_qty = $scrap_qty;
    }
     ...
     */
    public function getScrapQty(): float
    {
        return $this->scrap_qty;
    }

    /**
     * @param OdooRelation $scrap_location_id
     */
    public function setScrapLocationId(OdooRelation $scrap_location_id): void
    {
        $this->scrap_location_id = $scrap_location_id;
    }
     ...
     * @return OdooRelation
     *
     * @SerializedName("scrap_location_id")
     */
    public function getScrapLocationId(): OdooRelation
    {
